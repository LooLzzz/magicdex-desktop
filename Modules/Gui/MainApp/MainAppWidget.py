...
class MainAppWidget(MyStackedQWidget):
    ...
    def _createMenuBar(self):
        ...
        editMenu.addAction('Card Detection', lambda: self.showPage('cardDetection'))
        ...
        helpMenu.addAction('pHash Data Viewer', lambda: self.showPage('pHash'))
        helpMenu.addAction('Update pHash', self._update_phash)
